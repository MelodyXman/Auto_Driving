...
//        s23.engineOn(myCar23);
    ...
    static class Solution1 {
        ...
        private static boolean go(Car car, int x, int y, int curDirection, Set<String> visited, List<String> res) {
            // Clean current cell.
            car.walk();
            visited.add(x + " " + y);
            ...
            for (int i = 0; i < 4; i++) {
                ...
                if (!visited.contains(nx + " " + ny) && car.canMove()) {
                    if (go(car, nx, ny, curDirection, visited, res))
                        return true;
                }
